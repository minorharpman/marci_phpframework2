<header class="py-5 bg-light border-bottom mb-4">
            <div class="container">
                <div class="text-center my-5">
                    <h1 class="fw-bolder"> Willy Fog kalandjai...</h1>
                    <p class="lead mb-0">avagy 80 nap a Föld körül</p>
                </div>
            </div>
        </header>
        <!-- Page content-->
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a class="link link--eirene" href="public-post.php?id=<?= $articles[0]['id'] ?>"> <h2 class="card-title"><?= htmlspecialchars($articles[0]['title']) ?></h2> </a>
